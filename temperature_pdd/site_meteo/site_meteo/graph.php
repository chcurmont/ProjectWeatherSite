<?php
	...
	if(isset($_POST['data_type'])){
		...
		$x_axis_string=display_array_for_jploty_graph($x_axis,"string");
		$mean_array_string=display_constant_as_array($mean,$size);
		$max_array_string=display_constant_as_array($max,$size);
		$min_array_string=display_constant_as_array($min,$size);
	}
?>
...
<html>
	...
	<body>
		...
		<script>
			<?php echo 'var is_graph_empty='.$is_graph_empty;?>;
